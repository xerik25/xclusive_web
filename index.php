<?php include('header.php'); ?>
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      <!-- Indicators -->
      <img class="greenBar" src="/assets/img/content/GreenBar.png" alt="A Cool Green Bar">
      ...
      <div class="carousel-inner">
        ...
        <div id="slide1" class="carousel-image"></div> 
          <!--<img src="/assets/img/content/drinks.jpg" alt="First slide">-->
          <div class="container">
        ...
        <div id="slide2" class="carousel-image"></div> 
          <!--<img src="/assets/img/content/mixingitup.jpg" alt="Second slide">-->
          <div class="container">
            <div class="carousel-caption">
        ...
        <div id="slide3" class="carousel-image"></div> 
          <!--<img src="/assets/img/content/cody.jpg" alt="Third slide">-->
          <div class="container">
            <div class="carousel-caption">
