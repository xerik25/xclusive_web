<html>
  ...
  <!-- Plagins CSS -->
  <link rel="stylesheet" href="assets/css/buttons/buttons.css">
  <link rel="stylesheet" href="assets/css/buttons/social-icons.css">
          ...
          <div class="container">
            ...
            <div class="navbar-collapse collapse">
              <ul class="nav navbar-nav">
                ...
                <li><a href="#contact">Bar Services</a></li>
                <li><a href="#contact">Bartender for Hire</a></li>
                <li><a href="#contact">Contact</a></li>
<!--uncomment if we need dropdown menu
                <li class="dropdown">
